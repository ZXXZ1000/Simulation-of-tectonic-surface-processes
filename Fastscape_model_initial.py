...
from fastscape.processes import SingleFlowRouter, grid
from landlab.components import FlowAccumulator
from mpl_toolkits.axes_grid1 import make_axes_locatable
from fastscape.processes import UniformRectilinearGrid2D, BareRockSurface, HorizontalAdvection,SurfaceTopography
...
save_path = r"C:\Users\Administrator\Videos\fastscape_test\test7_ini"
...
x_gradient = np.linspace(0.01, 0.01, 300)
y_gradient = np.linspace(0.01, 0.08, 300)
...
uplift_rate_matrix = uplift_rate_matrix * 0.4 # Scale down uplift rate
Ksp = Ksp.flatten()
...
in_ds = xs.create_setup(
    model=basic_model,
    clocks={
        'time': np.linspace(0., time, 1000+1),
...
out_ds.to_netcdf(save_path + '/out_initial_step.nc')
